 ...
 */
router.post("/master-logout", requireAuthentication, userControllers.logoutAllDevices);
 ...
 */
router.post("/forgotpass", validators.forgotPasswordValidator, userControllers.forgotPassword);
